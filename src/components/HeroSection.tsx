    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-gray-900 to-black">
      ...
      <div className="relative container max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-16 z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-stretch lg:space-x-10 space-y-8 sm:space-y-12 lg:space-y-0">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center">
            ...
            <div className="animate-fade-in-up opacity-0" style={{ animationDelay: '0.2s' }}>
              <div className="inline-block mb-4 sm:mb-6">
                <span className="px-3 sm:px-4 py-1 sm:py-1.5 text-xs sm:text-sm bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border border-blue-500/30 rounded-full text-cyan-300 font-medium">
            ...
            <div className="animate-fade-in-up opacity-0" style={{ animationDelay: '0.3s' }}>
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4 sm:mb-6 leading-tight">
                ...
                <span className="block text-xl sm:text-2xl md:text-3xl font-light mt-2 sm:mt-3 text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">
            ...
            {/* Action buttons */}
            <div className="flex flex-wrap gap-3 sm:gap-4 mb-8 sm:mb-12 animate-fade-in-up opacity-0" style={{ animationDelay: '0.5s' }}>
              <a href="#contact" className="px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-medium rounded-lg flex items-center hover:shadow-lg hover:shadow-cyan-500/20 transition-all text-sm sm:text-base">
                <Mail className="mr-2" size={16} />
                Contact Me
              </a>
              <a href="#projects" className="px-4 sm:px-6 py-2 sm:py-3 bg-transparent border border-gray-600 text-gray-300 font-medium rounded-lg flex items-center hover:border-cyan-500 hover:text-cyan-400 transition-all text-sm sm:text-base">
            ...
            {/* Stats Grid */}
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-6 animate-fade-in-up opacity-0" style={{ animationDelay: '0.6s' }}>
              <div className="stats-card p-3 sm:p-4 bg-gray-900/50 rounded-lg border border-gray-800/50 hover:border-cyan-800/50 transition-colors">
                <Award className="text-cyan-400 mb-1 sm:mb-2" size={20} />
                <span className="text-xl sm:text-2xl font-bold text-white">3+</span>
                <span className="text-xs sm:text-sm text-gray-400 block">Years Experience</span>
              </div>
              <div className="stats-card p-3 sm:p-4 bg-gray-900/50 rounded-lg border border-gray-800/50 hover:border-emerald-800/50 transition-colors">
                <Terminal className="text-emerald-400 mb-1 sm:mb-2" size={20} />
              ...
              <div className="stats-card p-3 sm:p-4 bg-gray-900/50 rounded-lg border border-gray-800/50 hover:border-purple-800/50 transition-colors">
                <Server className="text-purple-400 mb-1 sm:mb-2" size={20} />
                <span className="text-xl sm:text-2xl font-bold text-white">20+</span>
                <span className="text-xs sm:text-sm text-gray-400 block">APIs Built</span>
              </div>
              <div className="stats-card p-3 sm:p-4 bg-gray-900/50 rounded-lg border border-gray-800/50 hover:border-blue-800/50 transition-colors">
                <Cloud className="text-blue-400 mb-1 sm:mb-2" size={20} />
          ...
          <div className="w-full lg:w-1/2 h-[350px] sm:h-[400px] md:h-[450px] lg:h-[500px] relative overflow-hidden rounded-2xl border border-gray-800 bg-black/40 backdrop-blur-sm shadow-xl">
            {/* Canvas container */}
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center p-4 sm:p-8 z-10">
              ...
              <div className="relative mb-6 sm:mb-12">
                <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full flex flex-col items-center justify-center bg-gradient-to-br from-blue-600/20 to-cyan-500/20 border border-cyan-500/30 shadow-lg shadow-cyan-500/10">
                  <span className="text-4xl sm:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-white to-cyan-200">4+</span>
                  <span className="text-sm sm:text-base text-cyan-300 font-medium">Years</span>
                </div>
                {/* Decorative rings */}
              ...
              {/* Skills section */}
              <div className="w-full max-w-md space-y-3 sm:space-y-5">
                <div className="text-center mb-3 sm:mb-6">
                  <h3 className="text-lg sm:text-xl font-medium text-white mb-1">Core Technologies</h3>
                  <div className="w-12 sm:w-16 h-1 bg-gradient-to-r from-cyan-500 to-blue-500 mx-auto rounded-full"></div>
                </div>
                ...
                <div className="skill-item">
                  <div className="flex justify-between mb-1">
                    ...
                    <span className="text-sm sm:text-base text-cyan-400 font-medium">98%</span>
                  </div>
                ...
                <div className="skill-item">
                  <div className="flex justify-between mb-1">
                    <span className="text-sm sm:text-base text-gray-300">Backend Architecture</span>
                    <span className="text-sm sm:text-base text-emerald-400 font-medium">94%</span>
                  </div>
                  <div className="w-full h-1.5 sm:h-2 bg-gray-800 rounded-full overflow-hidden">
                ...
                <div className="skill-item">
                  <div className="flex justify-between mb-1">
                    ...
                    <span className="text-sm sm:text-base text-purple-400 font-medium">92%</span>
                  </div>
                  <div className="w-full h-1.5 sm:h-2 bg-gray-800 rounded-full overflow-hidden">
                ...
                <div className="skill-item">
                  <div className="flex justify-between mb-1">
                    <span className="text-sm sm:text-base text-gray-300">Mobile App Development</span>
                    <span className="text-sm sm:text-base text-pink-400 font-medium">90%</span>
                  </div>
                  <div className="w-full h-1.5 sm:h-2 bg-gray-800 rounded-full overflow-hidden">
